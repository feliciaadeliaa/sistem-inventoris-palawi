<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('status') === 'profile-updated'): ?>
        <div class="mb-4 rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700 dark:border-green-800 dark:bg-green-500/10 dark:text-green-400">
            <?php echo e(__('Profil berhasil diperbarui.')); ?>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="flex items-center gap-5">
                    <img
                        src="<?php echo e($user->avatar ? asset('storage/' . $user->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode($user->name) . '&background=random'); ?>"
                        alt="<?php echo e($user->name); ?>"
                        class="h-20 w-20 rounded-full object-cover"
                    />
                    <div class="flex-1">
                        <label for="avatar" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                            <?php echo e(__('Foto Profil')); ?>
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <p class="mt-1.5 text-sm text-error-500"><?php echo e($message); ?></p>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            <?php echo e(__('Email kamu belum diverifikasi.')); ?>

                            <button form="send-verification" class="text-brand-500 underline hover:text-brand-600">
                                <?php echo e(__('Klik untuk kirim ulang email verifikasi.')); ?>
            ...
            <form method="POST" action="<?php echo e(route('password.update')); ?>" class="space-y-5">
                ...
                <div>
                    <label for="current_password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        <?php echo e(__('Password Saat Ini')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    <label for="password_confirmation" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        <?php echo e(__('Konfirmasi Password Baru')); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="rounded-2xl border border-error-200 bg-white p-6 dark:border-error-800 dark:bg-white/[0.03]">
            ...
            <p class="mb-5 text-sm text-gray-500 dark:text-gray-400">
                <?php echo e(__('Setelah akun dihapus, semua data akan hilang secara permanen. Pastikan kamu sudah yakin sebelum melanjutkan.')); ?>
            ...
            <form id="delete-account-form" method="POST" action="<?php echo e(route('profile.destroy')); ?>" class="mt-5 hidden space-y-4">
                <?php echo csrf_field(); ?>
                <?php echo method_field('delete'); ?>

                <div>
                    <label for="delete_password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                        <?php echo e(__('Masukkan password untuk konfirmasi')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <button type="submit"
                    ...
                    <?php echo e(__('Konfirmasi Hapus Akun')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\inventoris\sistem-inventoris-palawi\resources\views/profile/edit.blade.php ENDPATH**/ ?>